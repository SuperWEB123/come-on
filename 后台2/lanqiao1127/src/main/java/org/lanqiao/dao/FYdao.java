...
public class FYdao {
    ...
    public int fy(double hmoney, double harea,String hregion, String haddress, String housetype, String hsynopsis,String substring) throws SQLException {
       ...
       // String sql= "INSERT INTO house(hid,hmoney,harea,housetype,hphoto,hsynopsis) VALUES(?,?,?,?,?,?);";
        String sql="INSERT INTO housing(hmoney,harea,hregion,haddress,housetype,hphoto,hsynopsis) VALUES(?,?,?,?,?,?,?);";

        Object[] arr= {hmoney,harea,hregion,haddress,housetype,substring,hsynopsis};
